...
csv_path = r"C:\Users\a1611\Desktop\BioInfo\pocket_PCA\ESR2\pocket_descriptors_ESR2_dynamic.csv"
...
df.to_csv("pocket_PCA_ESR2.csv", index=False)
print("Saved PCA results → pocket_PCA_ESR2.csv")
